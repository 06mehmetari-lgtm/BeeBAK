...
public class BeeBAKDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BeeBAKGlobalFeatureConfigurator.Configure();
        BeeBAKModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BeeBAKDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BeeBAKResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/BeeBAK");

            options.DefaultResourceType = typeof(BeeBAKResource);
        ...
        {
            options.MapCodeNamespace("BeeBAK", typeof(BeeBAKResource));
        });
    }
}
