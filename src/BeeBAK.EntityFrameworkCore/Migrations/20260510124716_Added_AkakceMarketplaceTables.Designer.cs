...
namespace BeeBAK.Migrations
{
    ...
    [Migration("20260510124716_Added_AkakceMarketplaceTables")]
    partial class Added_AkakceMarketplaceTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeeBAK.Ecommerce.EcMarketplaceCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastNavigationSyncUtc")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<int?>("NavigationDisplayOrder")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppEcMarketplaceCategories", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Ecommerce.EcProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Marketplace", "ExternalProductId")
                        .IsUnique();

                    b.ToTable("AppEcProducts", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Ecommerce.EcProductDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SellerScoreJson")
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("AppEcProductDetails", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Ecommerce.EcProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEcProductImages", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Ecommerce.EcProductPriceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RawOfferJson")
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("AppEcProductPriceSnapshots", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Ecommerce.EcScrapeRun", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BeeBAK.Marketplaces.Akakce.AkakceMerchant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAkakceMerchants", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Marketplaces.Akakce.AkakceOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MerchantProductUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
                    ...
                    b.ToTable("AppAkakceOffers", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Marketplaces.Akakce.AkakceProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<decimal?>("BestPriceAmount")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.Property<decimal?>("PreviousPriceAmount")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.ToTable("AppAkakceProducts", (string)null);
                });
            ...
            modelBuilder.Entity("BeeBAK.Marketplaces.Cimri.CimriMerchant", b =>
                {
                    ...
                    b.ToTable("AppCimriMerchants", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Marketplaces.Cimri.CimriOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("InstallmentBadge")
                        .HasMaxLength(128)
                    ...
                    b.Property<decimal?>("MerchantScore")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)");
                    ...
                    b.ToTable("AppCimriOffers", (string)null);
                });

            modelBuilder.Entity("BeeBAK.Marketplaces.Cimri.CimriProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("BestPriceMerchantName")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.Property<string>("PrimaryCategorySlug")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.Property<int?>("TotalOfferCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PrimaryCategorySlug");
            ...
            modelBuilder.Entity("BeeBAK.Ecommerce.EcMarketplaceCategory", b =>
                {
                    b.HasOne("BeeBAK.Ecommerce.EcMarketplaceCategory", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("BeeBAK.Ecommerce.EcProduct", b =>
                {
                    b.HasOne("BeeBAK.Ecommerce.EcMarketplaceCategory", "PrimaryCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BeeBAK.Ecommerce.EcProductDetail", b =>
                {
                    b.HasOne("BeeBAK.Ecommerce.EcProduct", "Product")
                        .WithOne("Detail")
                        .HasForeignKey("BeeBAK.Ecommerce.EcProductDetail", "ProductId")
            ...
            modelBuilder.Entity("BeeBAK.Marketplaces.Akakce.AkakceOffer", b =>
                {
                    b.HasOne("BeeBAK.Marketplaces.Akakce.AkakceMerchant", "Merchant")
                        .WithMany()
                        .HasForeignKey("MerchantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BeeBAK.Marketplaces.Akakce.AkakceProduct", "Product")
                        .WithMany("Offers")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BeeBAK.Marketplaces.Cimri.CimriOffer", b =>
                {
                    b.HasOne("BeeBAK.Marketplaces.Cimri.CimriMerchant", "Merchant")
                        .WithMany()
                        .HasForeignKey("MerchantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BeeBAK.Marketplaces.Cimri.CimriProduct", "Product")
                        .WithMany("Offers")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
